        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <form action="insertPostit.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="postit_content" class="col-form-label">content</label>
                        <input type="text" name="postit_content" id="" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="users" class="col-form-label">To:</label>
