    ...
    <div class="page-container">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="createBrainstorming.php">Post new ideas</a></li>
        ...
        <div class="main-content">
            ...
            <form action="insertBrainstorming.php" method="post">
                    ...
                    <div class="form-group"> <input type="submit" class="btn btn-primary mt-4 pr-4 pl-4" value="done!!">
                    </div>
